...
function AreaCtrl(strP,strC,strA){
	...
	this.html = '<span>'+"<em class=mycity>"+strP+"</em>"+'<select name="Province" id="prov'+this.randomNum+'" '+onchgProvincesStr+' ></select></span>';
	if (this.level>1){this.html += '<span>'+"<em class=mycity>"+strC+"</em>"+'<select name="City" id="city'+this.randomNum+'" '+onchgCityStr+' ></select></span>';}					
	if (this.level>2){this.html += '<span>'+"<em class=mycity>"+strA+"</em>"+'<select name="Area" id="area'+this.randomNum+'"></select></span>';}
